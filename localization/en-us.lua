return {
    ...
    misc = {
        ...
        labels = {
            picubed_contractual = "Contractual",
        },
        achievement_names = {
			ach_picubed_printererror = "Printer Error!",
			ach_picubed_grossedoff = "Grossed Off",
			ach_picubed_stoned = "Stoned",
			ach_picubed_agrandmemorial = "A Grand Memorial",
			ach_picubed_dontgetcookedstay = "Don't Get Cooked, Stay...",
			ach_picubed_bananabreaker = "Banana Breaker",
